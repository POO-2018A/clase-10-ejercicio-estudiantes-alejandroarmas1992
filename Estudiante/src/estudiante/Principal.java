...
public class Principal {
     ...
     public static void main (String[] args){
        ...
        estudiantes[0]= new Estudiante("Byron", "Alemida", "0645278015");  
       ...
       estudiantes [0].setMaterias(m1); 
        ...
        for(int i=0; i<materiasEstudiante.length; i++){
          ...
          System.out.println();
        //3materias
        estudiantes[1]= new Estudiante("Juan ", "Elizalde", "1401458023");
        ...
        for(int i=0; i<materiaEstudiante.length; i++){
          ...
          System.out.println();
        //4 materias
        estudiantes[2]= new Estudiante("Luis", "Armas", "1709987944");
